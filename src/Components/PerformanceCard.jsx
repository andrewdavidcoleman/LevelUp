            ...
            {props.performances.length ?
                ...
                <>
                    ...
                    <div className="icons">
                        ...
                        <svg className="bi bi-card-list ml-3 cursor-pointer" onClick={() => dispatch({ page: 'PerformanceDetails', athlete: props.athlete, wod: props.wod, performances: props.performances })} width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
