          ...
          <div className="action-bar row align-items-center">
              <div className="col-4">
                  <div className="row justify-content-evenly">
                      <svg onClick={() => handleClick('AddAthlete')} className={'bi bi-person-plus ' + (page === 'AddAthlete' && 'active')} viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <svg onClick={() => handleClick('Home')} className={'bi bi-grid-3x3 ' + (page === 'Home' && 'active')} viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
