            ...
            <div className="action-bar row align-items-center">
                <div className="col-4">
                    <div className="row justify-content-evenly">
                            <svg onClick={() => dispatch({ page: 'AddAthlete'})} className={'bi bi-person-plus ' + (state.page === 'AddAthlete' && 'active')} viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg onClick={() => dispatch({ page: 'AddWod' })} className={'bi bi-file-plus ' + (state.page === 'AddWod' && 'active')} viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg onClick={() => dispatch({ page: 'Home' })} className={'bi bi-grid-3x3 ' + (state.page === 'Home' && 'active')} viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
